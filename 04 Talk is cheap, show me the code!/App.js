 ...
 *   --Restaurant Card
 *      --Image
 *      --Name of Restaurant , star Rating , cousines , delivery time etc
 * Footer
 * --Copyright
 * --Links
 * --Address
    ...
    return (
        <div className="header">
            <div className="logo-conatainer">
                <img className="logo"  src="https://mir-s3-cdn-cf.behance.net/project_modules/disp/cad72f16211207.562a6e3bb04cc.png"  />
            </div>
...
//OR  const RestaurantCard = ({resName , cuisine}) =>{      -----> Destructing of props
const RestaurantCard = (props) =>{
    const {resData} = props;

    const {name , cloudinaryImageId , cuisines , avgRating , costForTwo  , sla} = resData?.info; //optional chaining
    ...
    return (
        <div className="res-card" style={{ backgroundColor: "lightpink" }}>
            ...
            <h4 className="timing1">{sla.deliveryTime} minutes</h4>
        </div>
    );
};
...
const restaurantsList = [
  ...
  // not using keys (not acceptable) <<< index as key  <<<<<<<<< (greater symbol observation) unique id (best practice)
const Body = () => {
    return (
        <div className="body">
